            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={scaleIn} className="relative order-2 lg:order-1">
              ...
              <div className="absolute bottom-6 left-6 right-6 bg-white/90 backdrop-blur-xl rounded-2xl p-5 shadow-xl border border-sky-100">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="font-bold text-slate-900 text-sm">Pelajar Tahfiz Al-Quran</p>
                    <p className="text-xs text-slate-500">Fokus Tajwid & Makhraj</p>
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={scaleIn} className="max-w-md mx-auto relative group">
            ...
            <div className="relative p-8 sm:p-12 rounded-[2rem] bg-white border border-slate-100 shadow-xl text-center flex flex-col items-center">
              ...
              <div className="flex items-center justify-center gap-3 mb-2">
                ...
                <div className="flex items-baseline text-sky-500 drop-shadow-sm">
                  <span className="text-3xl sm:text-4xl font-amiri font-bold tracking-tight">RM</span>
                  <span className="text-[5rem] sm:text-[6.5rem] leading-none font-amiri font-bold tracking-tighter text-sky-500">30</span>
                </div>
              </div>
      ...
      <footer className="bg-sky-950 text-sky-300/70 py-10 sm:py-12">
        <div className="container mx-auto px-4 sm:px-6 max-w-7xl flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="text-center md:text-right flex flex-col items-center md:items-end gap-1">
            ...
            <p className="text-sm font-medium text-sky-100/80">© 2025 O-Iqra' Pendidikan. Hak cipta terpelihara.</p>
            <p className="text-[11px] text-sky-200/60 italic tracking-wide">Diuruskan oleh Alpha Growth Consultancy (202503208073 / JM1028402-H)</p>
          </div>
        </div>
      </footer>
